...
#define GOOGLE_SPEECH_TO_TEXT_KEY @"apikey" //Google speech apikey
...
- (void)postByteData:(NSData *)byteData {
    ...
    //NSString *urlString = [NSString stringWithFormat:@"https://www.google.com/speech-api/v2/recognize?xjerr=1&maxresults=10&pFilter=0&output=json&&client=chromium&lang=zh-TW&key=%@",GOOGLE_SPEECH_TO_TEXT_KEY];
    NSString *urlString = [NSString stringWithFormat:@"https://www.google.com/speech-api/v2/recognize?xjerr=1&maxresults=10&pFilter=0&output=json&&lang=zh-TW&key=%@",GOOGLE_SPEECH_TO_TEXT_KEY];
