...
@interface TypeItemView () <UITableViewDataSource, UITableViewDelegate>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    BIRTypeItem *item = [[tempArray objectAtIndex:indexPath.section] objectAtIndex:indexPath.row];
    
    cell.textLabel.text = [NSString stringWithFormat:@"%@. %@", item.typeId, item.name];
    cell.detailTextLabel.text = item.typeId;
