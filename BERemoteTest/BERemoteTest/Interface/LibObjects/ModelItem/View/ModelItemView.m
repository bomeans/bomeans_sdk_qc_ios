...
@interface ModelItemView () <UITableViewDataSource, UITableViewDelegate>

@end

@implementation ModelItemView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    BIRModelItem *item = [[tempArray objectAtIndex:indexPath.section] objectAtIndex:indexPath.row];
