...
@interface KeyNameView () <UITableViewDataSource, UITableViewDelegate>

@end

@implementation KeyNameView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    BIRKeyName *item = [[tempArray objectAtIndex:indexPath.section] objectAtIndex:indexPath.row];
    
    cell.textLabel.text = [NSString stringWithFormat:@"%@, %@", item.keyId, item.name];
    cell.detailTextLabel.text = item.keyId;
