...
@interface BrandItemView () <UITableViewDataSource, UITableViewDelegate>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    BIRBrandItem *item = [[tempArray objectAtIndex:indexPath.section] objectAtIndex:indexPath.row];
    
    cell.textLabel.text = [NSString stringWithFormat:@"%@. %@", item.brandId, item.name];
    cell.detailTextLabel.text = item.brandId;
