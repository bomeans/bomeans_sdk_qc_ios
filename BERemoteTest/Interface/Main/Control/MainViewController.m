...
- (void)didChangeServer
{
    ...
    UIAlertAction *twAction = [UIAlertAction actionWithTitle:@"TW" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        [self clearData];
        self.navigationItem.title = @"TW";
        self.navigationItem.leftBarButtonItem.title = @"TW";
        [BomeansIRKit setServer:BIRServerTW];
        //[BomeansIRKit setUseChineseServer:NO]; //預設值:NO=tw, YES=cn
        [_dataProvider setLanguage:@"tw"];
    }];
    UIAlertAction *cnAction = [UIAlertAction actionWithTitle:@"CN" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        [self clearData];
        self.navigationItem.title = @"CN";
        self.navigationItem.leftBarButtonItem.title = @"CN";
        [BomeansIRKit setServer:BIRServerCN];
    ...
    UIAlertAction *testAction = [UIAlertAction actionWithTitle:@"TEST" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        ...
        [BomeansIRKit setServer:BIRServerTEST];
        //[BomeansIRKit setUseChineseServer:NO]; //預設值:NO=tw, YES=cn
        [_dataProvider setLanguage:@"tw"];
    }];
    UIAlertAction *cancelAction = [UIAlertAction actionWithTitle:@"Cancel" style:UIAlertActionStyleCancel handler:nil];
    [alert addAction:twAction];
    [alert addAction:cnAction];
